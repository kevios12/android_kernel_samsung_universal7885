...
struct t_input_booster_device_tree_gender	mouse_booster_dt = {5,2,};			// type : 5,  level : 1
struct t_input_booster_device_tree_gender	mouse_wheel_booster_dt = {6,2,};	// type : 6,  level : 1
struct t_input_booster_device_tree_gender	hover_booster_dt = {7,2,};			// type : 7,  level : 1
struct t_input_booster_device_tree_gender	pen_booster_dt = {8,2,};			// type : 8,  level : 1
struct t_input_booster_device_tree_gender	key_two_booster_dt = {9,2,};			// type : 9,  level : 1
