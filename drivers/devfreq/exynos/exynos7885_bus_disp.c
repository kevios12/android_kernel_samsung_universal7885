...
static int exynos7885_devfreq_disp_resume(struct exynos_devfreq_data *data)
{
...
static int exynos7885_devfreq_disp_suspend(struct exynos_devfreq_data *data)
{
	if (pm_qos_request_active(&data->default_pm_qos_min))
		pm_qos_update_request(&data->default_pm_qos_min,
...
static int exynos7885_devfreq_disp_init_prepare(struct exynos_devfreq_data *data)
{
